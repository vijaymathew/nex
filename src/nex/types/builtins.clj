...
(def builtin-type-methods
  ...
  {:Any any-type-methods
   ...
   :Atomic_Reference atomic-reference-type-methods
   :Task task-type-methods
   :Channel channel-type-methods
   :Console console-type-methods
   :Process process-type-methods
   :ArrayCursor arraycursor-type-methods
   :StringCursor stringcursor-type-methods
   :MapCursor mapcursor-type-methods
   :SetCursor setcursor-type-methods})
...
(def builtins
  "Free (target-less) builtin functions, grouped by domain."
  (merge core-builtins

...
```
nex> print(true and true)
true

nex> print(true and false)
false

nex> print(false and false)
false
```
...
nex> print(age >= 13 and age <= 17)
true

nex> print(age < 13 or age > 17)
false
```
...
```
nex> print(true or false and false)
true
```
...
```
nex> print("  hello  ".trim.to_upper.length)
5
```
...
nex> print("BMI: " + bmi.round.to_string)
BMI: 23
```
